# QPJoy WireGuard Engine: macOS x64
...
- `resources/wireguard/darwin-x64/wg` or `.gz`
- `resources/wireguard/darwin-x64/wireguard-go` or `.gz`
- optional `resources/wireguard/darwin-x64/wg-quick` or `.gz`
- optional `resources/wireguard/darwin-x64/bash` or `.gz`
