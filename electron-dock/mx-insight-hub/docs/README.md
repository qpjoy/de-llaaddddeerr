...
21. [Nationwide province public-opinion source](architecture/province-public-opinion-source.md)
22. [Nationwide public-opinion sourcing and geography evidence](architecture/nationwide-public-opinion-sourcing.md)
23. [Nationwide province public-opinion operations](operations/province-public-opinion-ingestion.md)
24. [Public-opinion volume, quality and archive troubleshooting](operations/public-opinion-volume-quality-archive.md)
...
31. [Agent provider settings](operations/agent-provider-settings.md)
32. [Open capabilities, file rules and bounded classification cost](adr/0008-open-capabilities-file-rules-and-classification.md)
