...
20. [Backup and restore](operations/backup-restore.md)
21. [Observability and SLO](operations/observability-slo.md)
22. [BI and Data Agent evolution](architecture/bi-and-data-agent-evolution.md)
23. [Agent provider settings](operations/agent-provider-settings.md)
24. [Open capabilities, file rules and bounded classification cost](adr/0008-open-capabilities-file-rules-and-classification.md)
