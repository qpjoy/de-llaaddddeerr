...
export const MOBILE_COMMERCE_WRITER_CONTRACT_VERSION = 'mobile-commerce.writer.v1'
export const MOBILE_COMMERCE_WRITER_CONTRACT_SUMMARY = Object.freeze({
  ...
  deletion: 'Hard deletes are not observable in v1 and must not be used for rows that have entered this feed.',
  input: Object.freeze({
    ...
    requiredIndex: `(${MOBILE_COMMERCE_SOURCE_LOCATOR.cursorColumn}, ${MOBILE_COMMERCE_SOURCE_LOCATOR.idColumn})`,
