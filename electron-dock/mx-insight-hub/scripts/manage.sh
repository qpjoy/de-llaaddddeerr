...
create_runtime_config() {
  ...
  kubectl -n "$namespace" create configmap mx-insight-hub-config \
    ...
    --from-literal=MX_INSIGHT_JUSTONE_MAX_REQUESTS_PER_MINUTE="${MX_INSIGHT_JUSTONE_MAX_REQUESTS_PER_MINUTE:-50}" \
    ...
    --from-literal=MX_INSIGHT_TIKHUB_DETAIL_INTERVAL_MS="${MX_INSIGHT_TIKHUB_DETAIL_INTERVAL_MS:-5000}" \
    --from-literal=MX_INSIGHT_TIKHUB_DETAIL_MAX_WAIT_MS="${MX_INSIGHT_TIKHUB_DETAIL_MAX_WAIT_MS:-60000}" \
    --from-literal=MX_INSIGHT_TIKHUB_DETAIL_MAX_PENDING="${MX_INSIGHT_TIKHUB_DETAIL_MAX_PENDING:-12}" \
    --from-literal=MX_INSIGHT_TIKHUB_DETAIL_FRESH_TTL_MS="${MX_INSIGHT_TIKHUB_DETAIL_FRESH_TTL_MS:-300000}" \
    --from-literal=MX_INSIGHT_TIKHUB_DETAIL_STALE_TTL_MS="${MX_INSIGHT_TIKHUB_DETAIL_STALE_TTL_MS:-3600000}" \
